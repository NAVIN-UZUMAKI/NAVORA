    ...
    <div data-tutorial="mission-board" className="space-y-6 animate-fadeIn pb-16 lg:pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 py-2.5 px-5 rounded-xl font-hud font-bold text-sm tracking-wider text-shinobi-950 bg-gradient-to-r from-chakra-400 to-cyan-300 hover:from-chakra-300 hover:to-white transition shadow-chakra flex-shrink-0"
        >
          <Plus size={18} />
