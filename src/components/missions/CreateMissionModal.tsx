      ...
      <div className="relative w-full max-w-lg hud-panel rounded-2xl p-6 sm:p-7 border-chakra-500/40 shadow-chakra">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-shinobi-700/60">
            ...
            <button
              type="submit"
              className="py-2.5 px-5 rounded-xl font-bold text-shinobi-950 bg-gradient-to-r from-chakra-400 to-cyan-300 hover:from-chakra-300 hover:to-white transition-all shadow-chakra font-hud tracking-wider text-sm flex items-center gap-1.5"
            >
              <Plus size={16} />
