      ...
      <div className="hud-panel rounded-2xl p-8 border-shinobi-800 text-center space-y-6">
        ...
        <div>
          <button
            ...
            className="inline-flex items-center gap-2 py-2.5 px-5 rounded-xl font-hud font-bold text-sm tracking-wider text-white bg-gradient-to-r from-[#c2410c] to-[#f97316] hover:from-[#f97316] hover:to-[#fb923c] transition shadow-[0_0_16px_rgba(249,115,22,0.4)] border border-[#9CA3AF]/30"
          >
